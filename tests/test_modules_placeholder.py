...
MODULE_SPECS = [
    ...
    ("modules.nf_orchestrator", "run_orchestrator"),
    ...
    ("modules.nf_shared", "load_config"),
]


@pytest.mark.smoke
@pytest.mark.placeholder
@pytest.mark.parametrize("module_path, func_name", MODULE_SPECS)
...
@pytest.mark.unit
@pytest.mark.placeholder
@pytest.mark.parametrize("module_path, _", MODULE_SPECS)
