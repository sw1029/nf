...
window.cancelDocDialog = cancelDocDialog;
window.cancelDocMetaDialog = cancelDocMetaDialog;
...
window.handleTimelinePositionKey = handleTimelinePositionKey;
window.handleTimelinePointerDown = handleTimelinePointerDown;
window.handleLoadProject = handleLoadProject;
window.handleDocMetaGroupSelectChange = handleDocMetaGroupSelectChange;
window.loadDoc = loadDoc;
window.closeLeftSidebar = closeLeftSidebar;
window.moveTimelineDoc = moveTimelineDoc;
window.moveTimelineDocToPosition = moveTimelineDocToPosition;
window.openDocCtxMenu = openDocCtxMenu;
window.openDocMetaDialog = openDocMetaDialog;
...
window.submitDocDialog = submitDocDialog;
window.submitDocMetaDialog = submitDocMetaDialog;
